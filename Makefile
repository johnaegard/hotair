...
hotair:
	$(CC) -O -o build/HOTAIR.PRG -t cx16 -Ln hotair.lbl -C cx16-bank.cfg src/hotair.c src/wait.c

runhotair:
	../x16emu/x16emu -prg build/HOTAIR.PRG -run -debug
...
fire:
	$(CC) -O -o build/FIRE.PRG -t cx16 -Ln hotair.lbl src/fire.c src/wait.c
